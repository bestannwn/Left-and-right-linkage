//
//  GoodsClassCollectionViewFlowLayout.m
//  PH869-iOS
//
...
NSString *const GoodsClassollectionViewSectionBackground = @"GoodsClassollectionViewSectionBackground";

@implementation GoodsClassCollectionViewFlowLayout
...
- (void)setup{
    [self registerClass:[GoodsClassHeaderView class] forDecorationViewOfKind:GoodsClassollectionViewSectionBackground];
}
...
- (void)prepareLayout{
    ...
    if (!numberOfSections || ![delegate conformsToProtocol:@protocol(GoodsClassFlowLayoutDelegate)]) {
        return;
    }
    ...
    for (NSInteger section = 0; section < numberOfSections; section++) {
        ...
        // 2、定义
        GoodsClassCollectionViewLayoutAttributes *attr = [GoodsClassCollectionViewLayoutAttributes layoutAttributesForDecorationViewOfKind:GoodsClassollectionViewSectionBackground withIndexPath:[NSIndexPath indexPathForItem:0 inSection:section]];
...
- (NSArray *)layoutAttributesForElementsInRect:(CGRect)rect{
    ...
    for (UICollectionViewLayoutAttributes *attributes in superArray)
    {
        ...
        if ([attributes.representedElementKind isEqualToString:UICollectionElementKindSectionHeader])
        {
            ...
            attributes.zIndex = 700;
        }
    }
    
    // 遍历decorationViewAttrs
...
- (nullable UICollectionViewLayoutAttributes *)layoutAttributesForDecorationViewOfKind:(NSString*)elementKind atIndexPath:(NSIndexPath *)indexPath{
    if ([elementKind isEqualToString:GoodsClassollectionViewSectionBackground]) {
